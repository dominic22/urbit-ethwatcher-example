...
gulp.task('css-bundle', function() {
  ...
  return gulp
    ...
    .pipe(gulp.dest('./urbit/app/exampleapp/css'));
});
...
gulp.task('js-imports', function(cb) {
  return gulp.src('dist/index.js')
    ...
    .pipe(gulp.dest('./urbit/app/exampleapp/js/'))
    .on('end', cb);
});
...
gulp.task('js-minify', function () {
  return gulp.src('./urbit/app/exampleapp/js/index.js')
    .pipe(minify())
    .pipe(gulp.dest('./urbit/app/exampleapp/js/'));
});

gulp.task('tile-js-minify', function () {
  return gulp.src('./urbit/app/exampleapp/js/tile.js')
    .pipe(minify())
    .pipe(gulp.dest('./urbit/app/exampleapp/js/'));
});
